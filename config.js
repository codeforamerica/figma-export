module.exports = {
  ...
  'PAGES': ['11741-224247'],           // Add the pages in the file you want to extract from
  'COMPONENT': 'Application Question', // Name of the component you want to pull properties from
